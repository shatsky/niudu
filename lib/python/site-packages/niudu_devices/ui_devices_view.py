...
from PySide6.QtCore import Qt, QThread, Signal, Slot, QObject, QAbstractProxyModel
...
class DevicesView(QTreeView):
    ...
    def currentChanged(self, current, previous):
        ...
        # TODO somewhy this is now getting called with arg which causes item None, dirty fix
        device_item = self.model().itemFromIndex(current)
