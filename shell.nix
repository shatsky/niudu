...
pkgs.stdenv.mkDerivation {
  ...
  buildInputs = [ pkgs.cmake pkgs.zlib pkgs.libGL pkgs.xorg.libxcb pkgs.libudev pkgs_unstable.python3Packages.pyside2 pkgs.python3Packages.pydenticon pkgs.boost ];
  shellHook = ''
